...
//  TwitterClone
//
//  Created by Dmitryi Velko on 16.12.2022.
//
...
class RegisterViewController: UIViewController {
    ...
    // это место для сохранения подписок
    ...
    override func viewDidLoad() {
        ...
        // Добавляем распознаватель жестов для нашей вюшки, что бы при тапе по экрану скрыть клавиатуру
