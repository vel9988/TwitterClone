...
class ProfileTableViewHeader: UIView {
    ...
    private let profileHeaderImageView: UIImageView = {
        ...
        imageView.clipsToBounds = true
        imageView.translatesAutoresizingMaskIntoConstraints = false
        imageView.image = UIImage(named: "headerTest")
    ...
    private func configureStackButton() {
        for (i, button) in sectionStack.arrangedSubviews.enumerated() {
            ...
            button.addTarget(self, action: #selector(didTabTab(_:)), for: .touchUpInside)
        }
    }
    
    @objc private func didTabTab(_ sender: UIButton) {
    ...
    private func configureConstraints() {
        ...
        let profileHeaderImageViewConstraints = [
            ...
            profileHeaderImageView.widthAnchor.constraint(equalToConstant: 150)
        ]
        ...
        let joinedDateLabelConstraints = [
            ...
            joinedDateLabel.topAnchor.constraint(equalTo: joinDateImageView.topAnchor)
        ]
